...
; New to Crystal
	...
	const EVENT_PICKED_UP_PEARL_FROM_KABUTO_ITEM_ROOM
	const EVENT_PICKED_UP_HEAL_POWDER_FROM_KABUTO_ITEM_ROOM
	const EVENT_PICKED_UP_HELIX_FOSSIL_FROM_AERODACTYL_ITEM_ROOM
	const EVENT_PICKED_UP_KINGS_ROCK_FROM_AERODACTYL_ITEM_ROOM
	const EVENT_PICKED_UP_STARDUST_FROM_AERODACTYL_ITEM_ROOM
	const EVENT_PICKED_UP_ENERGYPOWDER_FROM_AERODACTYL_ITEM_ROOM
	const EVENT_PICKED_UP_OLD_AMBER_FROM_HO_OH_ITEM_ROOM
	const EVENT_PICKED_UP_QUICK_CLAW_FROM_HO_OH_ITEM_ROOM
	const EVENT_PICKED_UP_BIG_PEARL_FROM_HO_OH_ITEM_ROOM
	const EVENT_PICKED_UP_ENERGY_ROOT_FROM_HO_OH_ITEM_ROOM
	const EVENT_PICKED_UP_GS_BALL_FROM_OMANYTE_ITEM_ROOM
	const EVENT_PICKED_UP_LIGHT_BALL_FROM_OMANYTE_ITEM_ROOM
	const EVENT_PICKED_UP_STAR_PIECE_FROM_OMANYTE_ITEM_ROOM
	const EVENT_PICKED_UP_REVIVAL_HERB_FROM_OMANYTE_ITEM_ROOM
	...
	const EVENT_ILEX_FOREST_SILVER_POWDER
