...
; Johto hidden items - two more in Crystal Exclusive Events
	...
	const EVENT_ILEX_FOREST_HIDDEN_POISON_BARB
...
; Crystal-exclusive events in Johto
	...
	const EVENT_RUINS_OF_ALPH_OUTSIDE_HIDDEN_TWISTEDSPOON
	const EVENT_ROUTE_36_HIDDEN_TWISTEDSPOON
...
; More Johto story events
	...
	const EVENT_CONTEST_OFFICER_HAS_SILVERPOWDER
	const EVENT_CONTEST_OFFICER_HAS_POISON_BARB
...
; Kanto itemballs
	const EVENT_PICKED_UP_FOCUS_BAND ; See New to Crystal section for Black Belt event
...
; New to Crystal
	...
	const EVENT_PICKED_UP_DOME_FOSSIL_FROM_KABUTO_ITEM_ROOM
	const EVENT_PICKED_UP_FIRE_STONE_FROM_KABUTO_ITEM_ROOM
	const EVENT_PICKED_UP_SILVER_LEAF_FROM_KABUTO_ITEM_ROOM
	const EVENT_PICKED_UP_HEAL_POWDER_FROM_KABUTO_ITEM_ROOM
	const EVENT_PICKED_UP_HELIX_FOSSIL_FROM_OMANYTE_ITEM_ROOM
	const EVENT_PICKED_UP_BRICK_PIECE_FROM_OMANYTE_ITEM_ROOM
	const EVENT_PICKED_UP_GOLD_LEAF_FROM_OMANYTE_ITEM_ROOM
	const EVENT_PICKED_UP_ENERGYPOWDER_FROM_OMANYTE_ITEM_ROOM
	const EVENT_PICKED_UP_OLD_AMBER_FROM_AERODACTYL_ITEM_ROOM
	const EVENT_PICKED_UP_KINGS_ROCK_FROM_AERODACTYL_ITEM_ROOM
	const EVENT_PICKED_UP_BIG_PEARL_FROM_AERODACTYL_ITEM_ROOM
	const EVENT_PICKED_UP_ENERGY_ROOT_FROM_AERODACTYL_ITEM_ROOM
	const EVENT_PICKED_UP_GS_BALL_FROM_HO_OH_ITEM_ROOM
	const EVENT_PICKED_UP_BRIGHTPOWDER_FROM_HO_OH_ITEM_ROOM
	const EVENT_PICKED_UP_STAR_PIECE_FROM_HO_OH_ITEM_ROOM
	...
	const EVENT_PICKED_UP_BLACKBELT_I ; Kanto itemball
