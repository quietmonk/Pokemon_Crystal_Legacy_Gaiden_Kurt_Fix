...
Route36Officer_ContestHasConcluded:
	...
	iftrue .SilverPowder
	checkevent EVENT_CONTEST_OFFICER_HAS_POISON_BARB
	iftrue .PoisonBarb
...
Route36NationalParkGate_MapEvents:
	...
	object_event  2,  6, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, BugCatchingContestant3BScript, EVENT_BUG_CATCHING_CONTESTANT_3B
